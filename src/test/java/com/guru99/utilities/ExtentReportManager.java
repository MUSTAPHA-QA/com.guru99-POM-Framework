...
public class ExtentReportManager extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		if (htmlReporter == null) {
			...
			htmlReporter.config().setDocumentTitle("guru99 Web App Customer LifeCycle Suite By Mustapha");
			htmlReporter.config().setReportName("guru99 Web App Customer LifeCycle Suite Report");
